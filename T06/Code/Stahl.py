...
def steel():
    ...
    empty = Hist.read( directory + leer_names[0], "Leer", "Leer" )
    steel = Hist.read( directory + stahl_names[0], "Stahl", "Stahl Americium")
    ...
    for i in range(len(stahl_peaks)):
        steel_peaks = Hist.read( directory + stahl_peaks[i] , "Stahl", "Stahl Peaks Americium") 
